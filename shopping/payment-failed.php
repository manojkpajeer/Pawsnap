    ...
    <body>
        ...
        <?php
            if(empty($_GET['failed'])){
                ...
                <div class="info">
                    <div class="row">
                        <div class="col-12"> <span id="heading"><strong class="text-danger">Sorry</strong> : </span><br> <span id="details">Your payment failed. Please contact out support.</span> </div>
                    </div>
                </div>
                <?php
            } else {
                ...
                if (mysqli_num_rows($resGetData)>0) {
                    ...
                    ?>
                    <div class="title">Your transaction was failed!</div>
                    <div class="info">
                        <div class="row">
                            <div class="col-7"> <span id="heading">Date</span><br> <span id="details"><?php echo date_format(date_create($resGetData['DatePaid']), 'M d, Y');?></span> </div>
                            <div class="col-5 pull-right"> <span id="heading">Order No.</span><br> <span id="details"><?php echo $orderId;?></span> </div>
                        </div>
                    </div>
                    <div class="pricing">
                        <div class="row">
                            <div class="col-12"> <span id="name">Transaction ID : <?php echo $resGetData['TransactionId']; ?></span> </div>
                        </div>
                        <div class="row">
                            <div class="col-12"> <span id="name">Transaction Status : <?php echo $resGetData['PaymentMessage']; ?></span> </div>
                        </div>
                    </div>
                    <div class="total">
                        <div class="row">
                            <div class="col-8"></div>
                            <div class="col-4">Total : Rs.<?php echo number_format($resGetData['TotalAmount'], 2)."/-";?></div>
                        </div>
                    </div>
