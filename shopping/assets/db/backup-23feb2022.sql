...
-- Dumping data for table pawsandfur.ecom_sales: ~22 rows (approximately)
...
INSERT INTO `ecom_sales` (`ES_Id`, `CustomerId`, `OrderId`, `Status`, `DateCreate`, `Remarks`, `PaymentId`) VALUES
	...
	(20, 3, '1645635574621667F6F1990', 1, '2022-02-23 22:29:34', 'Order Placed', 16),
	(21, 3, '164563561862166822394B7', 0, '2022-02-23 22:30:18', 'Order Failed', 0),
	(22, 5, '164563745462166F4EE5AEB', 1, '2022-02-23 23:00:54', 'Order Placed', 18);
...
-- Dumping data for table pawsandfur.ecom_sales_temp: ~27 rows (approximately)
...
INSERT INTO `login_master` (`LM_Id`, `UserEmail`, `UserPassword`, `UserRole`) VALUES
	...
	(6, 'manu.mobile127@gmail.com', 'MAnoj143@@', 'Customer'),
...
-- Dumping data for table pawsandfur.payment_master: ~18 rows (approximately)
