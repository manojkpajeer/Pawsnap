<?php
    ...
    $sql = "SELECT product_master.ProductName, product_master.PM_Id, product_master.Image, product_master.Price, product_master.Discount FROM product_row JOIN product_master ON product_master.PM_Id = product_row.ProductId WHERE product_row.Status =1 AND product_row.Row = '2' AND product_master.Status = 1";
