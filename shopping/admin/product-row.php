<?php
    ...
    if(isset($_POST['add'])){
        ...
        if(mysqli_query($conn, "INSERT INTO product_row (ProductId, Status, DateCreate, Row) VALUES ('$_POST[category]', 1, NOW(), '1')")){
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid p-4">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="mb-3">Manage Product Row</h1>
                            </div>
                                ...
                                <div class="modal-content">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Add Product Row</h5>
                        ...
                        <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $resd6 = mysqli_query($conn, "SELECT product_row.PR_ID, product_master.ProductName, product_master.Image, product_row.ProductId, product_row.Status, product_row.DateCreate FROM product_row JOIN product_master ON product_master.PM_Id = product_row.ProductId WHERE product_row.`Row` = '1' ORDER BY product_row.PR_ID DESC");
                                                    ...
                                                    <div class="modal fade" id="modal<?php echo $rowd6['PR_ID'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <form method="POST" enctype="multipart/form-data">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLongTitle">Edit Product Row</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body g-3 row">
                                                                        <div class="col-sm-12 col-lg-12 col-md-12 mt-3">
