<?php
    ...
    if (isset($_GET['did'])) {
        ...
        if (mysqli_query($conn, "DELETE FROM personalise_card WHERE PC_ID = '$_GET[did]'")){

            echo "<script>alert('Yay, Card deleted successfully..');location.href='personalise-card.php';</script>";     
        } else {
    ...
    if (isset($_POST['update'])) { 
        ...
        if (mysqli_query($conn, "UPDATE personalise_card SET CategoryId = '$_POST[brand]', Status = '$_POST[status]' WHERE PC_ID = '$_POST[sid]'")) {
    ...
    if(isset($_POST['add'])){
        ...
        if(mysqli_query($conn, "INSERT INTO personalise_card(CategoryId, Status, DateCreate) VALUES ('$_POST[category]', 1, NOW())")){
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid p-4">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="mb-3">Manage Personalise Card</h1>
                            </div>
                                ...
                                <div class="modal-content">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Add Personalise Card</h5>
                        ...
                        <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $resd6 = mysqli_query($conn, "SELECT personalise_card.PC_ID, category_master.CategoryName, category_master.CategoryImage, personalise_card.CategoryId, personalise_card.Status, personalise_card.DateCreate FROM personalise_card JOIN category_master ON category_master.CT_Id = personalise_card.CategoryId ORDER BY personalise_card.PC_ID DESC");
                                        if (mysqli_num_rows($resd6) > 0) {
                                            ...
                                            while($rowd6 = mysqli_fetch_assoc($resd6)) {
                                                ...
                                                <a href="personalise-card.php?did=<?php echo $rowd6['PC_ID'];?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                                <?php
                                                echo "</td>";
                                                echo "</tr>"; 
                                                    ...
                                                    <div class="modal fade" id="modal<?php echo $rowd6['PC_ID'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <form method="POST" enctype="multipart/form-data">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLongTitle">Edit Personalise Card</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body g-3 row">
                                                                        <div class="col-sm-12 col-lg-12 col-md-12 mt-3">
