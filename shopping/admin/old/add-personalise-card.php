<?php
    ...
    if(isset($_POST['add'])){
        ...
        $resCheck = mysqli_query($conn, "SELECT PC_ID FROM personalise_card WHERE Status = 1 AND CategoryId = '$_POST[category]'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-6">
                                <div class="card mt-4 p-4">
                                    <span class="text-center h2">Add Personalise Card</span><a class="text-end" href="manage-personalise-card.php">View</a>
