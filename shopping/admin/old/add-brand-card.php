<?php
    ...
    if(isset($_POST['add'])){
        ...
        $resCheck = mysqli_query($conn, "SELECT BC_ID FROM brand_card WHERE Status = 1 AND BrandId = '$_POST[brand]'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-6">
                                <div class="card mt-4 p-4">
                                    <span class="text-center h2">Add Brand Card</span><a class="text-end" href="manage-brand-card.php">View</a>
