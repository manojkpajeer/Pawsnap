<?php
    ...
    if(isset($_POST['add'])){
        ...
        $resCheck = mysqli_query($conn, "SELECT PR_ID FROM product_row WHERE Status = 1 AND ProductId = '$_POST[category]' AND Row = '1'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-6">
                                <div class="card mt-4 p-4">
                                    <span class="text-center h2">Add Product</span><a class="text-end" href="manage-product-row1.php">View</a>
