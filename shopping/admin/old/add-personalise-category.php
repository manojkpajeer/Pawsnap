<?php
    ...
    if(isset($_POST['add'])){
        ...
        $resCheck = mysqli_query($conn, "SELECT PC_ID FROM personalise_category_menu WHERE Status = 1 AND CategoryId = '$_POST[category]'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-6">
                                <div class="card mt-4 p-4">
                                    <span class="text-center h2">Add Personalise Category</span><a class="text-end" href="manage-personalise-category.php">View</a>
                                    <form method="post" enctype="multipart/form-data" class="row">
                                        <div class="col-sm-12 col-lg-6 col-md-6 mt-3">
                                            ...
                                            <select class="form-control" name="category" title="Please choose category" required>
                                                <?php
                                                    $resCategory = mysqli_query($conn, "SELECT id, name FROM categories WHERE status = 1 AND ParentId = 3");
