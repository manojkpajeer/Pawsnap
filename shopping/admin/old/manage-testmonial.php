<?php
    ...
    if (isset($_GET['did'])) {
        ...
        if (mysqli_query($conn, "DELETE FROM testmonial_master WHERE TM_Id = '$_GET[did]'")){
            ...
            echo "<script>alert('Yay, Testimonial deleted successfully..');location.href='manage-testmonial.php';</script>";     
        } else {
    ...
    if (isset($_POST['update'])) { 
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], "../".$imagePath)) {
                ...
                Message = '$_POST[message]', Image = '$imagePath', Status = '$_POST[status]' WHERE TM_Id = '$_POST[test_id]'")) {
            ...
            if (mysqli_query($conn, "UPDATE testmonial_master SET UserName = '$_POST[name]', Location = '$_POST[location]',  
                Message = '$_POST[message]', Status = '$_POST[status]' WHERE TM_Id = '$_POST[test_id]'")) {
                                    ...
                                    <?php
                                        ...
                                        if (mysqli_num_rows($resd6) > 0) {
                                            ...
                                            while($rowd6 = mysqli_fetch_assoc($resd6)) {
                                                ...
                                                <a href="manage-testmonial.php?did=<?php echo $rowd6['TM_Id'];?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                                <?php
                                                echo "</td>";
                                                echo "</tr>"; 
