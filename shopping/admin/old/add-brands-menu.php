<?php
    ...
    if(isset($_POST['add'])){
        ...
        $resCheck = mysqli_query($conn, "SELECT BM_ID FROM brand_menu WHERE Status = 1 AND BrandId = '$_POST[brand]'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-8 col-md-6">
                                <div class="card mt-4 p-4">
                                    <span class="text-center h2">Add Brand Menu</span><a class="text-end" href="manage-brands-menu.php">View</a>
                                    <form method="post" enctype="multipart/form-data" class="row">
                                        <div class="col-sm-12 col-lg-6 col-md-6 mt-3">
                                            <label class="form-label">Select Brand</label>
                                            <select class="form-control" name="brand" title="Please choose category" required>
                                                <?php
                                                    $resCategory = mysqli_query($conn, "SELECT id, name FROM brands WHERE status = 1");
