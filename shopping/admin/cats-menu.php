<?php
    ...
    if (isset($_GET['did'])) {
        ...
        if (mysqli_query($conn, "DELETE FROM cat_category_menu WHERE CC_ID = '$_GET[did]'")){

            echo "<script>alert('Yay, Menu deleted successfully..');location.href='cats-menu.php';</script>";     
        } else {
    ...
    if (isset($_POST['update'])) { 
        ...
        if (mysqli_query($conn, "UPDATE cat_category_menu SET CategoryId = '$_POST[brand]', Status = '$_POST[status]' WHERE CC_ID = '$_POST[sid]'")) {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid p-4">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="mb-3">Manage Cats Menu</h1>
                            </div>
                                ...
                                <div class="modal-content">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Add Cats Menu</h5>
                                        ...
                                        <div class="modal-body g-3 row">
                                            <div class="col-sm-12 col-lg-12 col-md-12 mt-3">
                                                ...
                                                <select class="form-control" name="category" required>
                                                    <?php
                                                        $resCategory = mysqli_query($conn, "SELECT CT_Id, CategoryName FROM category_master WHERE Status = 1 AND ParentId = 2");
                        ...
                        <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $resd6 = mysqli_query($conn, "SELECT cat_category_menu.CC_ID, category_master.CategoryName, category_master.CategoryImage, cat_category_menu.CategoryId, cat_category_menu.Status, cat_category_menu.DateCreate FROM cat_category_menu JOIN category_master ON category_master.CT_Id = cat_category_menu.CategoryId ORDER BY cat_category_menu.CC_ID DESC");
                                        if (mysqli_num_rows($resd6) > 0) {
                                            ...
                                            while($rowd6 = mysqli_fetch_assoc($resd6)) {
                                                ...
                                                echo "<td>";
                                                ?>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal<?php echo $rowd6['CC_ID'];?>"><i class='fa fa-pen'></i></a> | 
                                                <a href="cats-menu.php?did=<?php echo $rowd6['CC_ID'];?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                                <?php
                                                echo "</td>";
                                                echo "</tr>"; 
                                                ...
                                                ?>
                                                    <div class="modal fade" id="modal<?php echo $rowd6['CC_ID'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <form method="POST" enctype="multipart/form-data">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLongTitle">Edit Cats Menu</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body g-3 row">
                                                                        <div class="col-sm-12 col-lg-12 col-md-12 mt-3">
                                                                        ...
                                                                        <input type="hidden" name="sid" value="<?php echo $rowd6['CC_ID'];?>">
