<?php
    ...
    if (isset($_GET['did'])) {
        ...
        if (mysqli_query($conn, "DELETE FROM slider_master WHERE SL_ID = '$_GET[did]'")){
            ...
            echo "<script>alert('Yay, Slider deleted successfully..');location.href='slider-data.php';</script>";     
        } else {
    ...
    if (isset($_POST['update'])) { 
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], $imagePath)) {
                ...
                if (mysqli_query($conn, "UPDATE slider_master SET Text = '$_POST[text]', SubText = '$_POST[sub_text]',  
                Title = '$_POST[name]', Status = '$_POST[status]', Link = '$_POST[link]', Image = '$imagePath' WHERE SL_ID = '$_POST[test_id]'")) {
            ...
            if (mysqli_query($conn, "UPDATE slider_master SET Text = '$_POST[text]', SubText = '$_POST[sub_text]',  
                Title = '$_POST[name]', Status = '$_POST[status]', Link = '$_POST[link]' WHERE SL_ID = '$_POST[test_id]'")) {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid p-4">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="mb-3">Manage Slider</h1>
                            </div>
                                    ...
                                    <?php
                                        ...
                                        if (mysqli_num_rows($resd6) > 0) {
                                            ...
                                            while($rowd6 = mysqli_fetch_assoc($resd6)) {
                                                ...
                                                <a href="slider-data.php?did=<?php echo $rowd6['SL_ID'];?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                                <?php
                                                echo "</td>";
                                                echo "</tr>"; 
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="modal-body g-3 row">
                                                                        ...
                                                                        <input type="hidden" name="test_id" value="<?php echo $rowd6['SL_ID'];?>">
