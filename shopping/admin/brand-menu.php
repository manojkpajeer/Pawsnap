<?php
    ...
    if (isset($_GET['did'])) {
        ...
        if (mysqli_query($conn, "DELETE FROM brand_menu WHERE BM_ID = '$_GET[did]'")){

            echo "<script>alert('Yay, Menu deleted successfully..');location.href='brand-menu.php';</script>";     
        } else {
    ...
    if (isset($_POST['update'])) { 
        ...
        if (mysqli_query($conn, "UPDATE brand_menu SET BrandId = '$_POST[brand]', Status = '$_POST[status]' WHERE BM_ID = '$_POST[sid]'")) {
    ...
    if(isset($_POST['add'])){
        ...
        if(mysqli_query($conn, "INSERT INTO brand_menu(BrandId, Status, DateCreate) VALUES ('$_POST[brand]', 1, NOW())")){
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid p-4">
                        <div class="row">
                            <div class="col-9">
                                <h3 class="mb-3">Manage Brand Menu</h1>
                            </div>
                                ...
                                <div class="modal-content">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Add Brand Menu</h5>
                        ...
                        <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                        $resd6 = mysqli_query($conn, "SELECT brand_menu.BM_ID, brand_master.BrandName, brand_master.BrandImage, brand_menu.BrandId, brand_menu.Status, brand_menu.DateCreate FROM brand_menu JOIN brand_master ON brand_master.BR_Id = brand_menu.BrandId ORDER BY brand_menu.BM_ID DESC");
                                        if (mysqli_num_rows($resd6) > 0) {
                                            ...
                                            while($rowd6 = mysqli_fetch_assoc($resd6)) {
                                                ...
                                                echo "<td>";
                                                ?>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal<?php echo $rowd6['BM_ID'];?>"><i class='fa fa-pen'></i></a> | 
                                                <a href="brand-menu.php?did=<?php echo $rowd6['BM_ID'];?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i></a>
                                                <?php
                                                echo "</td>";
                                                echo "</tr>"; 
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="modal-body g-3 row">
                                                                        ...
                                                                        <input type="hidden" name="sid" value="<?php echo $rowd6['BM_ID'];?>">
