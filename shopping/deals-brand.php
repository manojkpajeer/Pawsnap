<?php
    ...
    $sql = "SELECT brand_master.BR_Id, brand_master.BrandImage FROM brand_card JOIN brand_master ON brand_master.BR_Id = brand_card.BrandId WHERE brand_card.Status = 1 AND brand_master.Status = 1";
                    ...
                    ?>
                        <div class="col-xl-2 col-md-4 col-6 product-incfhny mt-4">
                            <div class="weitemshny-grid oposition-relative">
                                <a href="brands.php?source=<?php echo $rowProductRow1['BR_Id']?>&sort=default&discount=0&page=1" class="d-block zoom"><img src="../billing/<?php echo $rowProductRow1['BrandImage'];?>" alt="" class="img-fluid news-image"></a>
