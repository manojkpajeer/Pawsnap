<?php
    ...
    if(isset($_GET['searchitem'])){
        ...
        $sql = "SELECT product_master.ProductName, product_master.PM_Id, product_master.Image, product_master.Price, product_master.OnlineDiscount FROM product_master WHERE product_master.Status = 1 AND product_master.ProductName LIKE '%$searchText%'";
            ...
            <div class="ecom-contenthny py-3">
                <?php
                    ...
                    if(mysqli_num_rows($resProductRow1)>0){
                        ?>
                            <div class="container">
                                <h3 class="title-w3l">Showing result for "<?php echo $searchText;?>"</h3>
                        ...
                        <div class="ecom-contenthny py-5">
                            <?php
                                ...
                                if(mysqli_num_rows($resProductRow1)>0){
                                    ?>
                                        <div class="container">
                                            <h4 class="text-center">Sorry! No result found for "<?php echo $searchText;?>" :(</h4>
