<?php
    ...
    if(isset($_GET['searchitem'])){
        ...
        $sql = "SELECT product_master.ProductName, product_master.PM_Id, product_master.Image, product_master.Price, product_master.Discount FROM product_master WHERE product_master.Status = 1 AND product_master.ProductName LIKE '%$searchText%'";
