<?php
    ...
    if(isset($_GET['searchitem'])){
        ...
        $sql = "SELECT category_master.ParentId, product_master.ProductName, product_master.PM_Id, product_master.Image, product_master.Price, product_master.OnlineDiscount FROM product_master JOIN category_master ON category_master.CT_Id = product_master.CategoryId WHERE product_master.Status = 1 AND product_master.ProductName LIKE '%$searchText%'";
