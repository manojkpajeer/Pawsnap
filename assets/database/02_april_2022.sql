...
DROP DATABASE IF EXISTS `pawsandfur`;
...
DROP TABLE IF EXISTS `boarding_master`;
...
DROP TABLE IF EXISTS `category_card`;
...
DROP TABLE IF EXISTS `cat_category_menu`;
...
DROP TABLE IF EXISTS `dog_category_menu`;
...
DROP TABLE IF EXISTS `ecom_sales_temp`;
...
DROP TABLE IF EXISTS `personalise_card`;
...
DROP TABLE IF EXISTS `personalise_category_menu`;
...
DROP TABLE IF EXISTS `product_row`;
...
DROP TABLE IF EXISTS `slider_master`;
...
DROP TABLE IF EXISTS `testmonial_master`;
