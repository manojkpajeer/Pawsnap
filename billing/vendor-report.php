<?php 
    ...
    $sql = "SELECT * FROM vendor_master ORDER BY VM_Id DESC";

    if (isset($_POST['filter'])) {
        if ($_POST['customer_status'] != 'All') {
            $sql= "SELECT * FROM vendor_master WHERE Status = '$_POST[customer_status]' ORDER BY VM_Id DESC";
        } 
    }
    ?>
    ...
    <div class="pcoded-content">
        <div class="card">
            <div class="card-header pb-0 row">
                <div class="col-6"><h4>Vendor Report</h4></div>
