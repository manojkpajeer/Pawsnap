<?php 
    ...
    if (!empty($_GET['did'])) {
        ...
        if (mysqli_query($conn, "DELETE FROM billing_customer WHERE BC_Id = '$_GET[did]'")){
            
            echo "<script>alert('Yay, Customer deleted successfully..');location.href='customer.php';</script>";     
        } else {

            echo "<script>alert('Oops, Unable to delete customer.');location.href='customer.php';</script>";
        }
    }
    ...
    if (isset($_POST['update'])) { 
        ...
        if (mysqli_query($conn, "UPDATE billing_customer SET FullName = '$_POST[name]', EmailId = '$_POST[email]', Status = '$_POST[status]',
            ...
            echo "<script>alert('Oops, Unable to update customer..');</script>";
        }
    }
    ...
    if (isset($_POST['add'])) { 
        ...
        if(mysqli_query($conn, "INSERT INTO billing_customer(FullName, EmailId, PhoneNo, SecondaryNo, Address, Status, DateCreate) 
            ...
            echo "<script>alert('Oops, Unable to add customer..');</script>";
        }
    }
    ?>
    ...
    <div class="pcoded-content">
        <div class="card">
            ...
            <div class="card-header">
                <div class="col-sm-12 ">
                    <h4 style="float: left;">Manage Customer</h4>
            ...
            <div class="card-block">
                <div class="table-responsive dt-responsive table-sm">
                    <table id="dom-jqry" class="table table-hover table-bordered nowrap ">
                        ...
                        <?php
                        $resData = mysqli_query($conn, "SELECT * FROM billing_customer ORDER BY BC_Id DESC");
                        if(mysqli_num_rows($resData)>0)
                        {
                            ...
                            <tr>
                                ...
                                <td>    
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#manage<?php echo $row['BC_Id'];?>"><i class="feather icon-edit"></i></a> | 
                                    <a href="customer.php?did=<?php echo $row['BC_Id']?>" onclick="return confirm('Are you sure to delete this record?')"><i class="feather icon-trash"></i></a>
                                </td>
                            </tr>

                            <div class="modal fade" id="manage<?php echo $row['BC_Id'];?>" tabindex="-1" aria-labelledby="" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body row">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="form-label">Email Id</label>
                                                    <input type="email" class="form-control" required name="email" value="<?php echo $row['EmailId']; ?>">
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <label class="form-label">Phone No</label>
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    <label class="form-label">Secondary Phone No</label>
                                                    <input type="text" class="form-control" name="phone2" value="<?php echo $row['SecondaryNo']; ?>" pattern="[6-9]{1}[0-9]{9}" title="Phone number start with 6-9 and remaing 9 digit with 0-9" maxlength="10">
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <label class="form-label">Address</label>
                                                ...
                                                <input type="hidden" name="sid" value="<?php echo $row['BC_Id'];?>">
