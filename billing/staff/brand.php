<?php 
    ...
    if (isset($_POST['update'])) { 
        ...
        if(empty($_FILES['image']['name'])){
            ...
            if (mysqli_query($conn, "UPDATE brand_master SET BrandName = '$_POST[name]', Description = '$_POST[description]', Status = '$_POST[status]' WHERE BR_Id = '$_POST[sid]'")) {
            ...
            if(move_uploaded_file($_FILES['image']['tmp_name'], "../" . $imagePath)){
                ...
                if (mysqli_query($conn, "UPDATE brand_master SET BrandName = '$_POST[name]', Description = '$_POST[description]', Status = '$_POST[status]',
    ...
    if (isset($_POST['add'])) { 
        ...
        if(move_uploaded_file($_FILES['image']['tmp_name'], "../" . $imagePath)){
            ...
            VALUES ('$_POST[name]', '$_POST[description]', '$_POST[status]', NOW(), '$imagePath')")){
