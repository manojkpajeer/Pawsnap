                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" name="npass" placeholder="Enter New Password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" maxlength="12" title="Password must be 8 to 12 characters"/>
                                                        </div> 
                                                    </div>
                                                </div>
                                                <div class="row">
