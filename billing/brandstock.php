<?php 
    ...
    $sql= "select brand_master.BrandName as bname, product_master.PM_Id, product_master.ProductName, product_master.ProductCode from product_master join brand_master on brand_master.BR_Id = product_master.BrandId order by product_master.PM_Id desc;";
    ?>
