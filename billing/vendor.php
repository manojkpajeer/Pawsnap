<?php 
    ...
    if (isset($_POST['update'])) { 
        ...
        if(mysqli_query($conn, "UPDATE vendor_master SET FullName = '$_POST[name]' , PhoneNo = '$_POST[phone]',
            PhoneNo2 = '$_POST[phone2]', GSTIN  ='$_POST[gst]', Address = '$address', Status = '$_POST[status]' WHERE VM_Id = '$_POST[sid]'")){
    ...
    if (isset($_POST['add'])) { 
        ...
        if(mysqli_query($conn, "INSERT INTO vendor_master (FullName, PhoneNo, PhoneNo2, GSTIN, Address, DateCreate, Status) 
            VALUES ('$_POST[name]', '$_POST[phone]', '$_POST[phone2]', '$_POST[gst]', '$address', NOW(), '$_POST[status]')")){
