          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body px-3 row">
                  <div class="col-3">
                    <a href="customer-report.php">
                      <div class="p-2 card shadow" style="border-left: 6px solid #f06595;">
                        Customer Report
                      </div>
                    </a>
                  </div>
                  <div class="col-3">
                    <a href="vendor-report.php">
                      <div class="p-2 card shadow" style="border-left: 6px solid #ff922b;">
                        Vendors Report
                      </div>
                    </a>
                  </div>
                  <div class="col-3">
                    <a href="product-report.php">
                      <div class="p-2 card shadow" style="border-left: 6px solid #51cf66;">
                        Products Report
                      </div>
                    </a>
                  </div>
                  <div class="col-3">
                    <a href="purchase-report.php">
                      <div class="p-2 card shadow" style="border-left: 6px solid #20c997;">
                        Purchase Report
                      </div>
                    </a>
                  </div>
                  <div class="col-3">
                    <a href="sales-report.php">
                      <div class="p-2 card shadow" style="border-left: 6px solid #339af0;">
                        Sales Report
                      </div>
                    </a>
                  </div>
                  <div class="col-3">
                    <a href="stock.php">
                      <div class="p-2 card shadow" style="border-left: 6px solid #845ef7;">
                        Stock Report
                      </div>
                    </a>
                  </div>
                  <div class="col-3">
                    <a href="credit-report.php">
                      <div class="p-2 card shadow" style="border-left: 6px solid #ff6b6b;">
                        Credit Report
                      </div>
                    </a>
                  </div>
