<?php 
    ...
    if (isset($_POST['update'])) { 
        ...
        if(empty($_FILES['image']['name'])){
            ...
            if (mysqli_query($conn, "UPDATE category_master SET CategoryName = '$_POST[name]', Description = '$description', Status = '$_POST[status]',
    ...
    if (isset($_POST['add'])) { 
        ...
        if(move_uploaded_file($_FILES['image']['tmp_name'], $imagePath)){
            ...
            VALUES ('$_POST[name]', '$description', '$_POST[status]', NOW(), '$_POST[parent]', '$imagePath')")){
